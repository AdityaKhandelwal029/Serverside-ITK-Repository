...
extern DLLAPI int Flender_execute_callbacks1(int *decision, va_list argc)
{
	*decision = ALL_CUSTOMIZATIONS;
	printf("\n***************************************");
	printf("\n  DLL Register And Login Successfull to teamcenter ");
	printf("\n***************************************\n\n");
...
//			}
//
//			vAttachments.push_back(tAttachments[i]);
//		}
//	}
